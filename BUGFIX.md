...
1. **Mancanza di slide/esercitazioni** → Esegui lo script di aggiornamento
    ...
    ![bugfix-3a.png](assets/images/bugfix-3a.png)  
    - Scarica lo script:  
    ![bugfix-3b.png](assets/images/bugfix-3b.png)
    - Posiziona lo script nella cartella del corso (è sul Desktop):  
    ![bugfix-3c.png](assets/images/bugfix-3c.png)
        - NON tra i **Download**!
        - Ctrl+C, Ctrl+V per mettere il file nella cartella giusta
    - Esegui lo script:  
    ![bugfix-3d.png](assets/images/bugfix-3d.png)
    - Se salta fuori questo avviso, eseguite comunque lo script:  
    ![bugfix-3e.png](assets/images/bugfix-3e.png)